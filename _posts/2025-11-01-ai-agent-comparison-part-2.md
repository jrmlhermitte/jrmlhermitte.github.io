...
experience. Below are the results, metrics, and the hands‑on impressions.

## Results

To help with brainstorming and include some diversity of opinion, Claude Sonnet
4.5 was added as an independent judge, and its scores are included below. These
numbers have been reviewed and verified. See
[here](/pdfs/2025-10-30-ai-generated-model-comparison.pdf) for a comprehensive
summary (generated by Claude and peer reviewed).

### Summary

_(Claude’s self-scores vs. human developer assessment.)_

| Model         | Claude's Score | Human Score | Lines Added | QA Fixes | Test Files | Architecture Grade |
| ------------- | -------------- | ----------- | ----------- | -------- | ---------- | ------------------ |
...
### Developer Rubric Summary

_Claude’s rubric emphasizes structural rigor, while the human evaluation focuses
more on day-to-day developer experience._
...
**Part 3** explores what happened when one simple instruction was
changed to one simple instruction: asking the Product Owner persona to
explicitly _reason through architectural trade‑offs._ That single tweak
transformed Claude's performance by nearly
